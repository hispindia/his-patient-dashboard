...
public class MedicalCertificateController {
    @RequestMapping(value = "/medicalCertificate.htm", method = RequestMethod.GET)
    public String firstView(@RequestParam(value = "patientId", required = false) Integer patientId, Model model) {
        ...
        return "module/patientdashboard/opdForms/medicalCertificate";
    }

    @RequestMapping(value = "/getmedicalcertificatedetail.list", method = RequestMethod.GET)
